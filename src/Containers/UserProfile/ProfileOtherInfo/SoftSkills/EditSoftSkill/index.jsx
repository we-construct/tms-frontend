...
import {deleteSoftSkill, editSoftSkill} from "../../../../../Redux/Profile/actions";
...
const EditSoftSkill = ({ id, skills, deleteSoftSkill, editSoftSkill }) => {
...
function mapDispatchToProps(dispatch) {
  return {
    deleteSoftSkill: (data) => dispatch(deleteSoftSkill(data)),
    editSoftSkill: (data) => dispatch(editSoftSkill(data)),
  };
}

export default connect(null, mapDispatchToProps)(EditSoftSkill);
